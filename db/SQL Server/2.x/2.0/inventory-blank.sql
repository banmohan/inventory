...
-->-->-- src/Frapid.Web/Areas/MixERP.Inventory/db/SQL Server/2.x/2.0/src/05.views/inventory.verified_suppliers_transaction_view.sql --<--<--

IF OBJECT_ID('inventory.verified_suppliers_transaction_view') IS NOT NULL
DROP VIEW inventory.verified_suppliers_transaction_view
GO
