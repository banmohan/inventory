...
namespace ASP
{
    ...
    public partial class _Views_Tasks_Transfer_Verification_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        ...
        public override void Execute()
        {
            ...
            #line 3 "..\..\Views\Tasks\Transfer\Verification.cshtml"
  
    ViewBag.Title = "Transfer Verification";
...
WriteLiteral(">Inventory Transfer Verification</div>\r\n    <div");
...
"ecklistAnchor.attr(\"href\", \"/dashboard/inventory/tasks/inventory-transfers/check" +
"list/\" + tranId);\r\n\r\n            var journalAdviceAnchor = $(\"<a title=\'View Jou" +
"rnal Advice\'><i class=\'print icon\'></i></a>\");\r\n            journalAdviceAnchor." +
"attr(\"href\", \"javascript:void(0);\");\r\n            journalAdviceAnchor.attr(\"oncl" +
"ick\", \"showJournalAdvice(\" + tranId + \");\");\r\n\r\n            var inventoryAdviceA" +
"nchor = $(\"<a title=\'View Transfer Advice\'><i class=\'zoom icon\'></i></a>\");\r\n   " +
...
"ournalView = $(\"#JournalView\");\r\n    var modal = $(\"#ActionModal\");\r\n    var ver" +
"ifyButton = $(\"#VerifyButton\");\r\n    var tranId;\r\n    var approve;\r\n\r\n    functi" +
"on getSelectedItem() {\r\n        var selected = journalView.find(\"input:checked\")" +
...
".html(\"Reject Transaction\");\r\n        subheader.html(window.stringFormat(\"TranId" +
": #{0}\", tranId));\r\n        header.removeClass(\"green\").addClass(\"red\");\r\n\r\n    " +
"    if (approve) {\r\n            header.html(\"Approve Transaction\");\r\n           " +
" header.removeClass(\"red\").addClass(\"green\");\r\n        };\r\n\r\n        modal.modal" +
"(\'setting\', \'closable\', false).modal(\'show\');\r\n    };\r\n\r\n    $(\"#VerificationApp" +
"roveButton\").click(function () {\r\n        tranId = getSelectedItem();\r\n\r\n       " +
" if (tranId) {\r\n            approve = true;\r\n            showModal();\r\n        }" +
";\r\n    });\r\n\r\n    $(\"#VerificationRejectButton\").click(function () {\r\n        tr" +
"anId = getSelectedItem();\r\n\r\n        if (tranId) {\r\n            approve = false;" +
"\r\n            showModal();\r\n        };\r\n    });\r\n\r\n    function removeRow(index," +
" callback) {\r\n        journalView.find(\"tr\").eq(index + 1).addClass(\"negative\")." +
...
"/inventory/tasks/inventory-transfers/verification/\" + type;\r\n            var dat" +
"a = JSON.stringify(model);\r\n\r\n            return window.getAjaxRequest(url, \"POS" +
"T\", data);\r\n        }\r\n\r\n        var model = getModel();\r\n        var type = app" +
"rove ? \"approve\" : \"reject\";\r\n\r\n        var ajax = request(model, type);\r\n\r\n    " +
"    ajax.success(function (response) {\r\n            var cascadingTranId = parseF" +
"loat(response);\r\n\r\n            if (cascadingTranId) {\r\n                journalVi" +
"ew.find(\"tr td:nth-child(3)\").each(function (i) {\r\n                    var tranI" +
"d = parseFloat($(this).text() || 0);\r\n\r\n                    if (cascadingTranId " +
"=== tranId) {\r\n                        removeRow(i);\r\n                    };\r\n  " +
"              });\r\n            };\r\n\r\n            journalView.find(\"input:checked" +
"\").first().parent().parent().parent().remove();\r\n            hideModal();\r\n     " +
"   });\r\n\r\n        ajax.fail(function (xhr) {\r\n            window.logAjaxErrorMes" +
"sage(xhr);\r\n        });\r\n\r\n        return false;\r\n    });\r\n\r\n    $(document).key" +
"up(function (e) {\r\n        if (e.ctrlKey) {\r\n            var rowNumber = e.keyCo" +
"de - 47;\r\n\r\n            if (rowNumber < 10) {\r\n                journalView.find(" +
...
"ts/source/Areas/MixERP.Inventory/Reports/Transfer.xml?transaction_master_id=\" + " +
"tranId);\r\n\r\n        setTimeout(function () {\r\n            $(\".advice.modal\")\r\n  " +
"              .modal(\'setting\', \'transition\', \'horizontal flip\')\r\n              " +
"  .modal({\r\n                    blurring: true\r\n                })\r\n            " +
"    .modal(\"show\");\r\n\r\n        }, 300);\r\n    };\r\n    function showJournalAdvice(" +
"tranId) {\r\n        $(\".modal iframe\").attr(\"src\", \"/dashboard/reports/source/Are" +
"as/MixERP.Finance/Reports/JournalEntry.xml?transaction_master_id=\" + tranId);\r\n\r" +
"\n        setTimeout(function () {\r\n            $(\".advice.modal\")\r\n             " +
"   .modal(\'setting\', \'transition\', \'horizontal flip\')\r\n                .modal({\r" +
"\n                    blurring: true\r\n                })\r\n                .modal(" +
"\"show\");\r\n\r\n        }, 300);\r\n    };\r\n</script>");
